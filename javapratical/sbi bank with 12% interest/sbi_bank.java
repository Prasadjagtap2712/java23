/*Write a program of class of SBI Bank having data members customer id, customer
name, customer city, mob number, account number and account amt. insert all
records. Create sub class Account_info from SBI Bank and calculate total amount
with interest rate 12%. And display all records.
*/
